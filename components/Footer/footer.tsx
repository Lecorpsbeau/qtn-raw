...
export default function Footer() {
    ...
    const email = "quentinpa13@gmail.com";
    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.wrapper}>
                ...
                {/* Gauche : Nom de marque */}
                <div className={styles.logo}>
                    qtn<span>.raw</span>
                </div>

                {/* Droite : Liens réseaux & Copie Email */}
                <div className={styles.links}>
                    ...
                    {/* Bouton Copie Mail */}
                    <button onClick={handleCopy} className={styles.linkItem}>
                        ...
                        <span className={copied ? styles.copied : ""}>
